#
#  Be sure to run `pod spec lint WxxKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "WxxKit"
  s.version      = "0.0.1"
  s.summary      = "A short description of WxxKit."
  ...
  s.source       = { :git => "http://EXAMPLE/WxxKit.git", :tag => "#{s.version}" }
